...
<div class="content">
	...
	<div class="grid-container">
		...
		<div class="grid2">
			...
			<form:form modelAttribute="oForm" method="POST" action="${postForm}"
				...
				<fieldset>
					...
					<div class="control-group">
						<%-- 								<form:label path="categoryTransaCction" class="control-label">Transaction :</form:label> --%>
						<cform:select path="categoryTransaction" label="Transaction" />
					...
					<div class="control-group">
						...
						<cform:select label="Transaction :" path="categoryTransaction" />
						<%-- 								<form:select path="categoryTransaction" multiple="false" size="1"></form:select> --%>
						<!-- 							</div> -->
						<%-- <div class="control-group">
								<form:label path="assets" class="control-label">Asset :</form:label> --%>
						<cform:select label="Asset :" path="assets"
						...
						<div class="control-group">
							...
							<cform:textarea path="note" label="note" />
							<form:label path="note" class="control-label">note :</form:label>
