	...
	<table>
		...
		<tbody>
			...
			<tr id="first" height="20">
				<td height="20" align="right" class="borderright price">
...
<div class="content notsw">
	...
	<div class="rightheader">
		<div class="btn-area">
			<a href="${URL}/purchase/bills/${id}/edit" class="btn netral "><i class="icon-pencil icon-grey"></i> RALAT</a>
			<a href="" class="btn netral print"><i class="icon-grey icon-print"></i>CETAK</a>
			<a href="javascript:void(0);" class="btn close negative cancel" data-id="${id}"><i class="icon-close icon-white"></i>BATAL</a>
		</div>
		<div class="totalbar ">
			...
			<div class="fr">
				<span class="total-price price">${form.total}</span>
			</div>
			<div class="clear"></div>
		</div>
		<div class="form">
			...
			<div class="field">
				<label>Kode Bongkar:</label>
				<input  class="fr input-mini text-right" value="${form.refNumber}" readonly/>
			</div>

			<div class="inputholder">
				<label>Supplier:</label>

				<input path="supplierId" id="supplier" class="medium text-right border-bottom" value="${form.supplierName}" readonly/>
				<textarea class="long address" disabled="true" />${form.supplierAddress}</textarea>
			</div>
			
			<div class="field">
				<label>Warehouse:</label>
				<div class="field-content fr">
					<input class="medium text-right" value="${warehouseName}" readonly/>
				</div>
			</div>
		</div>
	</div>
