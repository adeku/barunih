			...
			<form:form modelAttribute="formIN" action="${addAction}"
				...
				<div class="field">
					...
					<div class="item_dropdown">
						<form:input path="catalog_item_id" cssClass="focus-tab"
				...
				<div class="field">
					<label>Alasan :</label>
					<form:textarea path="notes" cssClass="focus-tab" target-tab="#btSAve" target-type="button"/>
				</div>
			</form:form>
			<br /> <button id="btSAve" class="btn positive focus-tab"><i class="icon-file icon-white"></i>SIMPAN</button> 
